...
bool js_cocos2dx_ui_TextField_setCursorFromPoint(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_cocos2dx_ui_TextField_setCursorFromPoint : wrong number of arguments: %d, was expecting %d", argc, 1);
    return false;
}
...
void js_register_cocos2dx_ui_TextField(JSContext *cx, JS::HandleObject global) {
    ...
    static JSFunctionSpec funcs[] = {
        ...
        JS_FN("setCursorFromPoint", js_cocos2dx_ui_TextField_setCursorFromPoint, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
